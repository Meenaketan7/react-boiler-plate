        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              {/* Supports */}
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/supports")}>
                  <Link to="/supports">
                ...
                <SidebarMenuItem>
                  ...
                  <CollapsibleContent>
                    <SidebarMenuSub className="group-data-[collapsible=icon]:hidden">
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton asChild isActive={isActive("/reports/completion-ratio")}>
                          <Link to="/reports/completion-ratio">
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton asChild isActive={isActive("/reports/time-spend-analytic")}>
                          <Link to="/reports/time-spend-analytic">
